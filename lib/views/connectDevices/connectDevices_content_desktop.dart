...
class ConnectDevicesContentDesktop extends StatelessWidget {
  final int userId;
  final ConnectionManager connectionManager; // Define connectionManager

  const ConnectDevicesContentDesktop({Key? key, required this.userId, required this.connectionManager}) // Add connectionManager to constructor
      : super(key: key);
